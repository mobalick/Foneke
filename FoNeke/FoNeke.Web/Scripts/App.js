...
jQuery(function ($) {
    ...
    //$.datepicker.setDefaults($.datepicker.regional[twoLetterISOLanguageName]);
    ...
    $('#id-input-file-3').ace_file_input({
        ...
        preview_error: function(filename, errorCode) {
    ...
    $('#id-file-format').removeAttr('checked').on('change', function() {
        ...
        var noIcon;
        if (this.checked) {
            btnChoose = "Drop images here or click to choose";
            noIcon = "icon-picture";
            beforeChange = function(files, dropped) {
                var allowedFiles = [];
            ...
            btnChoose = "Drop files here or click to choose";
            noIcon = "icon-cloud-upload";
            beforeChange = function(files, dropped) {
                return files;
            };
        }
        var fileInput = $('#id-input-file-3');
        fileInput.ace_file_input('update_settings', { 'before_change': beforeChange, 'btn_choose': btnChoose, 'no_icon': noIcon });
    ...
    $('.date-range-picker').daterangepicker().next().on(ace.click_event, function() {
        $(this).prev().focus();
    });
    ...
    $(".cartouche-search").on(ace.click_event, function (e) {
        ...
        $('#cartouche-dialog')
			...
			.dialog({
			    modal: true,
                title: "<div class='widget-header widget-header-small'><h4 class='smaller'><i class='icon-ok'></i>Sélection " + controller+"</h4></div>",
			    title_html: true,
